...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="w-full py-12 md:py-24 bg-red-50 dark:bg-gray-950">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Quick Access</h2>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
          ...
          >
            <motion.div variants={item}>
              <Card className="h-full overflow-hidden group hover:shadow-lg transition-all duration-300 border-2 hover:border-red-600/50">
                <CardHeader className="flex flex-row items-center gap-4 pb-2">
                  <div className="p-2 bg-red-100 dark:bg-red-900/30 rounded-full transition-transform duration-300 group-hover:scale-110">
              ...
              <Card className="h-full overflow-hidden group hover:shadow-lg transition-all duration-300 border-2 hover:border-red-600/50">
                <CardHeader className="flex flex-row items-center gap-4 pb-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Workshops, seminars, and competitions</CardDescription>
                  </div>
                </CardHeader>
                <CardContent>
              ...
              <Card className="h-full overflow-hidden group hover:shadow-lg transition-all duration-300 border-2 hover:border-red-600/50">
                <CardHeader className="flex flex-row items-center gap-4 pb-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Faculty, facilities, and more</CardDescription>
                  </div>
                </CardHeader>
                <CardContent>
